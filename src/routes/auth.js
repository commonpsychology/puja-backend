...
body('password')
  ...
  body('emergency_contact_name')
    ...
    .isLength({ min: 2, max: 100 }).withMessage('Emergency contact name must be 2–100 characters.'),
  body('emergency_contact_phone')
    .trim()
    .notEmpty().withMessage('Emergency contact phone is required.')
    .matches(/^9[678]\d{8}$/).withMessage('Emergency contact phone must be a valid Nepali number.'),
