...
const roomBookingsRoutes      = require('./src/routes/roomBookings')
const adminRoomBookings = require('./src/routes/adminRoomBookings')
const adminRooms        = require('./src/routes/adminRooms')
