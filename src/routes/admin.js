// src/routes/admin.js — CLEAN VERSION
// Fixes applied:
//   1. Removed duplicate communityController require block (was re-declared mid-file)
//   2. Removed duplicate unguarded community/group route blocks
//   3. Removed duplicate router.post('/debug-create-rider') block
//   4. Removed duplicate router.get/put/delete('/group-reservations') block
//   5. All routes now use guard middleware consistently
